...
|---|---|---|---|---|---|---|---|
| `hier_addone` | ce **←** | **0.8290 ± 0.0148** | - | 0.8748 ± 0.0164 | 0.7980 | 0.8600 | 3 |
| `simclr` | selfcon **←** | **0.7541 ± 0.0255** | - | 0.7952 ± 0.0479 | 0.8283 | 0.6800 | 3 |
| `stacked_randaug` | supcon **←** | **0.8190 ± 0.0284** | - | 0.8626 ± 0.0154 | 0.7980 | 0.8400 | 3 |
| _(lantai)_ | **SATURASI SAJA** | **0.7136** | - | 0.7430 | - | - | - |
...
Angkanya **0.7136** (AUC 0.7430). saturasi warna
...
Lantai saturasi punya AUC **0.7430** - setara salah mengurutkan **424 dari 1650 pasangan** (mati x hidup). Konfigurasi berikut mengurutkan **lebih baik dari itu**, bahkan setelah dikurangi satu simpangan baku:

| Augmentasi | Metode | AUC | pasangan salah urut | n seed |
|---|---|---|---|---|
| `hier_addone` | ce | **0.8748 ± 0.0164** | 206.6 dari 1650 | 3 |
| `stacked_randaug` | supcon | **0.8626 ± 0.0154** | 226.7 dari 1650 | 3 |
| `simclr` | selfcon | **0.7952 ± 0.0479** | 338.0 dari 1650 | 3 |
...
- Terbaik pada diagonal: **ce** + `hier_addone` (bal.acc 0.8290 ± 0.0148). Pada **AUC** ceritanya berbeda: lihat bagian "Yang berhasil melewati lantai" di atas - ada konfigurasi yang mengurutkan lebih baik daripada lantai di seluruh 3 seed, dan yang belum beres di situ cuma ambangnya.
